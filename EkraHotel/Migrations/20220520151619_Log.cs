    ...
    public partial class Log : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FreeTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsHotels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewsHotels_Customers_CustomersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FreeServices_Customers_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FreeServices_FreeTypes_TypeId",
                        column: x => x.TypeId,
                        principalTable: "FreeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_RoomsType_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Text = table.Column<string>(type: "text", nullable: false),
                    Stars = table.Column<int>(type: "integer", nullable: false),
                    StaffIdId = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomersId = table.Column<Guid>(type: "uuid", nullable: false),
                    Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewsStaffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReviewsStaffs_Customers_CustomersId",
                        column: x => x.CustomersId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReviewsStaffs_Staffs_StaffIdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FreeServices_CustomersId",
                table: "FreeServices",
                column: "CustomersId");

            migrationBuilder.CreateIndex(
                name: "IX_FreeServices_TypeId",
                table: "FreeServices",
                column: "TypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewsHotels_CustomersId",
                table: "ReviewsHotels",
                column: "CustomersId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsStaffs_CustomersId",
                table: "ReviewsStaffs",
                column: "CustomersId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewsStaffs_StaffIdId",
                table: "ReviewsStaffs",
                column: "StaffIdId");
